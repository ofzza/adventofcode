...
public partial class Day11: ISolution<(long, string), long> {
  ...
  public List<SolutionExecution<(long, string), long>> Executions { get; } = new List<SolutionExecution<(long, string), long>>() {
    // Part #1, Test
    new SolutionExecution<(long, string), long>(1, Tag.Test) {
      InputValue = (2, Day11.test),
      Expect = 374
    },
    // Part #1, Solution
    new SolutionExecution<(long, string), long>(1, Tag.Solution) {
      InputValue = (2, File.ReadAllText("./inputs/Day11/input.txt").Trim()),
      Expect = 9563821
    },
    // Part #2, Test
    new SolutionExecution<(long, string), long>(2, Tag.Test) {
      InputValue = (10, Day11.test),
      Expect = 1030
    },
    // Part #2, Solution
    new SolutionExecution<(long, string), long>(2, Tag.Solution) {
