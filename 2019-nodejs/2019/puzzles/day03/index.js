...
const puzzle        = require('../../../lib').puzzle,
      intersections = require('../../lib/intersections');

// Set global inputs
const input = [
  require('fs').readFileSync(require('path').join(__dirname, './input.txt')).toString().trim().split('\n')[0].split(',').map(a => a.trim()),
...
module.exports.puzzle01 = () => {
  puzzle('2019', '03', '01', puzzle01, [
    [['R8','U5','L5','D3'], ['U7','R6','D4','L4']],                                                                                     { expected: 6 },
    [['R75','D30','R83','U83','L12','D49','R71','U7','L72'], ['U62','R66','U55','R34','D71','R55','D58','R83']],                        { expected: 159 },
    [['R98','U47','R26','D63','R33','U87','L62','D20','R33','U53','R51'], ['U98','R91','D20','R16','D67','R40','U7','R15','U6','R7']],  { expected: 135 },
    input,                                                                                                                              { expected: 1626, example: false }
  ]);
};
...
module.exports.puzzle02 = () => {
  puzzle('2019', '03', '02', puzzle02, [
    [['R8','U5','L5','D3'], ['U7','R6','D4','L4']],                                                                                     { expected: 30 },
    [['R75','D30','R83','U83','L12','D49','R71','U7','L72'], ['U62','R66','U55','R34','D71','R55','D58','R83']],                        { expected: 610 },
    [['R98','U47','R26','D63','R33','U87','L62','D20','R33','U53','R51'], ['U98','R91','D20','R16','D67','R40','U7','R15','U6','R7']],  { expected: 410 },
    input,                                                                                                                              { expected: 27330, example: false }
  ]);
};
